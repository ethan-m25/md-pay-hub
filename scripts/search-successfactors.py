#!/usr/bin/env python3
# md-pay-hub/scripts/search-successfactors.py
# MD Equal Pay for Equal Work Act — salary range required in all postings (eff. Oct 1 2024)

LOG_FILE  = "/Users/clawii/md-pay-hub/scripts/successfactors.log"
LOCK_FILE = "/Users/clawii/md-pay-hub/scripts/.successfactors.lock"
...
SEED_PORTALS = load_successfactors_seeds('md')
REGION_TERMS    = ['bethesda', 'rockville', 'silver spring', 'columbia', 'baltimore', 'annapolis', 'gaithersburg', 'beltsville', 'laurel', 'greenbelt', 'college park', 'chevy chase', 'germantown', ', md,', ', md ', 'maryland']
NON_REGION_TERMS = ['virginia', 'washington, dc', 'district of columbia']
CITY_MAP        = {'bethesda': 'Bethesda, MD', 'rockville': 'Rockville, MD', 'silver spring': 'Silver Spring, MD', 'columbia': 'Columbia, MD', 'baltimore': 'Baltimore, MD', 'annapolis': 'Annapolis, MD', 'gaithersburg': 'Gaithersburg, MD', 'beltsville': 'Beltsville, MD'}
DEFAULT_LOCATION = 'Maryland, MD'
SALARY_MIN      = 30000
SALARY_MAX      = 1000000
